...
source("D:/knou/Multivariate/data/nreadMatrix.r")

datam = scan("D:/knou/Multivariate/data/country1968.txt")
country_name = scan("D:/knou/Multivariate/data/countryname.txt", what="")
country_name
